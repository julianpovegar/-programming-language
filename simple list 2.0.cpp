...
void list::pop_index(unsigned int index)
{
	...
	else if (index != 0 && index > size() && index > Size)
	{
          ...
          cout << "there are no elements in that position";
		  cout << endl;
		  cout << "Do you want to delete the last element?"<< endl;
		  cout << "if you want to remove it enter the number 1 otherwise enter the number 2"<<endl;
		  int ty;
          cin >> ty;
		  if (ty==1)
		  {
		  ...
		  {
			  cout << "the element has not been deleted";
			  return;
		  }
		  else
		  {
